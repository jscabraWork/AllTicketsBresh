...
@Component({
  selector: 'app-agregar-foto-mapa',
  templateUrl: './agregar-foto-mapa.component.html',
  styleUrls: ['./agregar-foto-mapa.component.css']
})
export class AgregarFotoMapaComponent implements OnInit {
  ...
  upload(index, file) {
    ...
    this.servicio.uploadImagenMapa(file, this.idEvento).subscribe(event => {
