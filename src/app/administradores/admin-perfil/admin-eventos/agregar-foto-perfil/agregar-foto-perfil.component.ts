...
@Component({
  selector: 'app-agregar-foto-perfil',
  templateUrl: './agregar-foto-perfil.component.html',
  styleUrls: ['./agregar-foto-perfil.component.css']
})
export class AgregarFotoPerfilComponent implements OnInit {
  ...
  upload(index, file) {
    ...
    this.servicio.uploadFotoEvento(file, this.idEvento).subscribe(event => {
