...
@Component({
  selector: 'app-agregar-foto-ciudad',
  templateUrl: './agregar-foto-ciudad.component.html',
  styleUrls: ['./agregar-foto-ciudad.component.css']
})
export class AgregarFotoCiudadComponent implements OnInit {
  ...
  upload(index, file){
    ...
    this.servicio.uploadImagenCiudad(file, this.idCiudad).subscribe(event =>{
